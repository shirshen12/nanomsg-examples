...
def main():
  ...
  server_sock.bind("ipc://test-ipc-sock")

  # status message for declaring server comming up online
  print "An REP server at ipc://test-ipc-sock is comming online"
  ...
  try:
    ...
    while (1):
      ...
      server_sock.send("Thank you from server_sock at: ipc://test-ipc-sock")
